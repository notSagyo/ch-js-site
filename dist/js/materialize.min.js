...
// COLLAPSIBLE
document.addEventListener('DOMContentLoaded', function () {
	let elems = document.querySelectorAll('.collapsible', '.product-filter');
...
function initMaterialboxed() {
	let elems = document.querySelectorAll(
		'.materialboxed, .product-li__image img, .cart-item__image img');
	let instances = M.Materialbox.init(elems, { });
}
document.addEventListener('DOMContentLoaded', initMaterialboxed);

// TOOLTIPPED
function initTooltipped () {
	let elems = document.querySelectorAll('.tooltipped');
	let instances = M.Tooltip.init(elems, { position: 'top', margin: 0, exitDelay: 200 });
}
document.addEventListener('DOMContentLoaded', initTooltipped);
...
// PRODUCTS SECTION
// PRICE SLIDER
let priceSlider = document.getElementById('test-slider');
